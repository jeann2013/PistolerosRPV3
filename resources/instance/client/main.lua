...
Citizen.CreateThread(function()
	while true do
		...
		if insideInstance then
			...
			RemoveAllPickupsOfType(0xbfefff6d)
			RemoveAllPickupsOfType(0xe284c527)
			RemoveAllPickupsOfType(0xefe7e2df)
			RemoveAllPickupsOfType(0x12e82d3d)
			RemoveAllPickupsOfType(0xaf113f99)
			RemoveAllPickupsOfType(0x624fe830)
			RemoveAllPickupsOfType(0x13532244)
			RemoveAllPickupsOfType(0x42bf8a85)
			RemoveAllPickupsOfType(0xd205520e)
			RemoveAllPickupsOfType(0x22d8fe39)
			RemoveAllPickupsOfType(0x9d07f764)
			RemoveAllPickupsOfType(0x42bf8a85)
			RemoveAllPickupsOfType(0x1b06d571)
			RemoveAllPickupsOfType(0xb1ca77b1)
			RemoveAllPickupsOfType(0x2be6766b)
			RemoveAllPickupsOfType(0xbfd21232)
			RemoveAllPickupsOfType(0xc1b3c3d1)
			RemoveWeaponDrops()
		end
	end
end)
