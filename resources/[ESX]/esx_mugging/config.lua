...
Config.MinMoney = 150                 --  Min amount of money received from mugging
Config.MaxMoney = 200               --  Max amount of money received from mugging.
Config.RobWaitTime = 5              --  Current seconds it takes to finish mugging
Config.AddItemsPerctent = 3       --  This is percent the script will add items as well as cash from mugging set to 0 to turn off.
Config.AddItemsMax = 3              --  This is the max number of items you can receive from NPC from mugging - min is 1
Config.CoolDownTime = 5            --  This is time between mugging NPC in seconds. Setting to 0 will turn off cooldown.
