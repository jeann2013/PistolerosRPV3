...
function OpenBossMenuBanda(society, close, options)
	options = options or {}
	local elements = {}
...
AddEventHandler('esx_society:openBossMenuBanda', function(society, close, options)
	OpenBossMenuBanda(society, close, options)
end)
