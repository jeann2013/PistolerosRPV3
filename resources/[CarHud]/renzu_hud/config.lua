...
config.enablecompass = false -- enable/disable compass
...
config.statusplace = 'bottom-center' -- available option top-right,top-left,bottom-right,bottom-left,top-center,bottom-center
...
config.turboprop = false -- show turbo prop
config.lagamount = {
	['default'] = 20,
	['street'] = 50,
    ['sports'] = 100,
...
--CARLOCK
config.carlock = false -- Enable Car Keyless System -- using owned_vehicles table from mysql, fetch owner as identifier.
config.carlock_distance = 20 -- max distance to fetch the sorrounding vehicles
config.enable_carjacking = false -- if true, pressing the Keybind for carlock when no owned vehicle in distanced the carjacking function will be used instead, with minigame from cd_keymaster resource ( DEPENDENCY )
...
config.enable_engine_prop = false -- use engine stand and engine prop while installing engine.
...
config.commands = {
   ...
   -- clothing = 'clothing',
	...
	carui = 'simple', -- usage:carui (simple,minimal,modern), example: carui simple
