...
Utilities = assert(Utilities or load_file('menuv/components/utilities.lua'))
CreateMenuItem = assert(CreateMenuItem or load_file('menuv/components/item.lua'))
CreateMenu = assert(CreateMenu or load_file('menuv/components/menu.lua'))
