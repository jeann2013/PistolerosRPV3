...
local menu_native = MenuV:CreateMenu('MenuV', 'Welcome to MenuV', 'topleft', 255, 0, 0, 'size-125', 'example', 'menuv', 'example_namespace', 'native')
...
menu_native:OpenWith('keyboard', 'F2') -- Press F2 to open menu Native :D