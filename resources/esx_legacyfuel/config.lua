...
Config.Strings = {
	ExitVehicle = "Sal de auto para llenar de gasolina",
	EToRefuel = "Presione ~g~E ~w~para llenar de gasolina",
	JerryCanEmpty = "Bidon vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Presione ~g~E ~w~comprar un bidón por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presione ~g~E ~w~para cancelar el llenado",
	CancelFuelingJerryCan = "Presione ~g~E ~w~para cancelar el llenado",
	NotEnoughCash = "No hay suficiente dinero",
	RefillJerryCan = "Presione ~g~E ~w~ para rellenar el bidón para ",
	NotEnoughCashJerryCan = "No hay suficiente dinero en efectivo para recargar bidones",
	JerryCanFull = "Bidon full",
	TotalCost = "Costo",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presione ~g~E ~w~agarrar un bidón"
	Config.Strings.RefillJerryCan = "Presione ~g~E ~w~ para llenar el bidón"
end
