...
m.messages = {   
    'Message ^1Bandas Gratis, contacta a jeann',
    '^4Message No robes autos a menos que vallas hacer algo ilegal',
    '^7Message Valora tu vida!',
    'Message ^6Respeta el Rol de tus OOC amigos',
    '^8Message Nuestro Discord es->https://discord.gg/fheTAvrC',
}
