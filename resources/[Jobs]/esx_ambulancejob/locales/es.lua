Locales['es'] = {
  ...
  ['player_not_conscious'] = 'el jugardor esta inconsiente!',
  -- Boss Menu
  ...
  ['fast_travel'] = 'presione ~INPUT_CONTEXT~ para ir rapido.',
  ...
  ['ems_menu_small'] = 'curas de pequeñas heridas',
  ['ems_menu_big'] = 'tratamiento de lesiones graves',
  -- Phone
  ...
  ['distress_send'] = 'presione [~b~G~s~] to send distress signal',
  ...
  ['used_bandage'] = 'Has usado ~y~1x~s~ bendaje',
