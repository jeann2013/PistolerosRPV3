...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'kap' then      
      ...
      for k,v in pairs(Config.LosSantosVagosStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'kap' and PlayerData.job.grade_name == 'boss' then          
        ...
        if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
          ...
          then
            TriggerEvent('esx_kap:hasExitedMarker', LastStation, LastPart, LastPartNum)
            hasExited = true
          end
          ...
          TriggerEvent('esx_kap:hasEnteredMarker', currentStation, currentPart, currentPartNum)
        end
...
function EnterExitEntityZoneEvents(coords)
  ...
  if closestDistance ~= -1 and closestDistance <= 3.0 then
    if LastEntity ~= closestEntity then
      TriggerEvent('esx_kap:hasEnteredEntityZone', closestEntity)
      LastEntity = closestEntity          
    end
  else
    if LastEntity ~= nil then
      TriggerEvent('esx_kap:hasExitedEntityZone', LastEntity)
      LastEntity = nil      
    end
  end   
end
...
function KeyControlPed(CurrentAction,PlayerData,CurrentActionMsg)
  if CurrentAction ~= nil then
    ...
    if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'kap' and (GetGameTimer() - GUI.Time) > 150 then
      ...
      if CurrentAction == 'delete_vehicle' then
        ...
        if Config.EnableSocietyOwnedVehicles then
          ...
          TriggerServerEvent('esx_society:putVehicleInGarage', 'kap', vehicleProps)
          ...
          then
            TriggerServerEvent('esx_service:disableService', 'kap')
          end
      ...
      if CurrentAction == 'menu_boss_actions' then
        ...
        TriggerEvent('esx_society:openBossMenuBanda', 'kap', function(data, menu)
  ...
  if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'kap' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'kap_actions') and (GetGameTimer() - GUI.Time) > 150 then
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_kap:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'kap', vehicleProps)
...
function OpenLosSantosVagosActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'kap_actions',
    {
      title    = 'kap',
      align    = 'right',
      elements = {
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_kap:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_kap:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_kap:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_kap:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_kap:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_kap:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_kap:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_kap', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_kap:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_kap:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_kap:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_kap:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_kap:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_kap:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_kap:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_kap:getStockItem', itemName, count)
              menu.close()
              menu2.close()              
              OpenGetStocksMenu()
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_kap:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_kap:putStockItems', itemName, count)
              menu2.close()
              menu.close()
              OpenPutStocksMenu()   
            end
...
AddEventHandler('esx_kap:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_kap:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_kap:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'kap' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_kap:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_kap:handcuff')
AddEventHandler('esx_kap:handcuff', function()
...
RegisterNetEvent('esx_kap:drag')
AddEventHandler('esx_kap:drag', function(cop)
...
RegisterNetEvent('esx_kap:putInVehicle')
AddEventHandler('esx_kap:putInVehicle', function()
...
RegisterNetEvent('esx_kap:OutVehicle')
AddEventHandler('esx_kap:OutVehicle', function(t)
