...
AddEventHandler('esx_carteljob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_', function(inventory)
...
ESX.RegisterServerCallback('esx_carteljob:getFineList', function(source, cb, category)
  ...
  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_latriada WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_carteljob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_', function(store)
...
ESX.RegisterServerCallback('esx_carteljob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_', function(account)
